    ...
    <div class="intro-y col-span-12 lg:col-span-4 xl:col-span-3" style="position: fixed;">
      <div class="box mt-5">
        <div class="px-4 pb-3 pt-5">
          <a class="flex rounded-lg items-center px-4 py-2 {{ Request::is('pelamar/lowonganKerja/1#informasi_umum*') ? 'bg-theme-1 text-white font-medium' : '' }}"
            href="#informasi_umum">
            <i data-feather="activity" class="w-4 h-4 mr-2"></i>
            <div class="flex-1 truncate">Informasi Umum</div>
          </a>
          <a class="flex rounded-lg items-center px-4 py-2 mt-1" href="#kualifikasi">
            <i data-feather="box" class="w-4 h-4 mr-2"></i>
            <div class="flex-1 truncate">Kualifikasi</div>
          </a>
          <a class="flex rounded-lg items-center px-4 py-2 mt-1" href="#persyaratan">
            <i data-feather="lock" class="w-4 h-4 mr-2"></i>
            <div class="flex-1 truncate">Persyaratan</div>
          </a>
          <a class="flex rounded-lg items-center px-4 py-2 mt-1" href="#pelamar">
