                ...
                <div class="p-5" id="horizontal-form">
                    <div class="preview">
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input name="email" type="email" class="input w-full border my-2"
                                placeholder="example@gmail.com" value="{{ old('email') ?? $data->email }}" disabled>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            <label class=" w-full lg:w-40 sm:w-20 sm:text-left">Upload Berkas</label>
                            <div>
                                <input name="berkas" type="file" class="input w-full border my-2"
                        ...
                        <div class="md:flex sm:flex md:space-x-4 sm:space-x-4">
                            <div class="flex-1 p-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center">
                                    ...
                                    <input name="tempat_lahir" type="text" class="input w-full border my-2"
                                ...
                                <div class="flex flex-col sm:flex-row items-center">
                                    ...
                                    <input name="no_telp" type="text" class="input w-full border my-2"
                                        placeholder="Nomor Telepon"
                                        value="{{ old('no_telp') ?? $data->pelamar->no_telp }}">
                                </div>
                                <div class="flex flex-col sm:flex-row items-center">
                                    <label class="w-full lg:w-40 sm:w-20 sm:text-left">Foto Profil</label>
                                    <input type="file" class="input w-full border my-2" name="foto"
                            ...
                            <div class="flex-1 p-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center">
                                    ...
                                    <input name="sd" type="text" class="input w-full border my-2"
                                ...
                                <div class="flex flex-col sm:flex-row items-center">
                                    ...
                                    <input name="smp" type="text" class="input w-full border my-2"
                                ...
                                <div class="flex flex-col sm:flex-row items-center">
                                    ...
                                    <input name="sma" type="text" class="input w-full border my-2"
